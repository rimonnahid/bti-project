...
//First Introduce
        ...
        $pdf->Cell(93,4,'Web Activities , Web design and development',0,0,'L',true);
        $pdf->Cell(.5,4,'','R',0);
        $pdf->Ln();
        $pdf->Cell(46.5,32,'',0,0);
        ...
        $pdf->Cell(.4,4,'','B',0,'L',0);
        $pdf->Cell(141,4,'HTML, CSS, Bootstrap, Javascript, PHP,Mysql, Laravel, Vue.js.','B'.'R',0,'L',true);
        $pdf->Ln();
        $pdf->Cell(190,.4,'',0,0);
        $pdf->Ln(2);
        ...
        $pdf->Cell(190,5,'Hi,My name is Mohammed Rimon (Nahid).I am a full stack Wordpress and Web developer.However I do blogging, content writing, editing, FB page/',0,0,'L');
        $pdf->Ln();
        $pdf->Cell(190,5,'groups manage, collecting social responses, optimizing.I mentioned all my skill in this CV.My vision isto gain confidence and fame using my potential',0,0,'L');
        $pdf->Ln();
        $pdf->Cell(190,5,'in the field of web technologies and express my innovative creative skills for myself and my company.',0,0,'L');
        $pdf->Ln();
        $pdf->Ln();
        ...
        $pdf->Ln();
        $pdf->Cell(.5,4,'','L',0);
        $pdf->Cell(46,4,'Personal Website',0,0,'L',true);
        ...
        $pdf->Cell(.5,4,'',0,0,'L',0);
        $pdf->Cell(140.5,4,'Made by HTML, CSS, Bootstrap, Javascript, PHP, Mysql, Laravel, Vue.js (view demo)',0,0,'L',true,'http://rimonnahid.storialtech.com/inventory/');
        $pdf->Cell(.5,4,'','R',0);
        $pdf->Ln();
